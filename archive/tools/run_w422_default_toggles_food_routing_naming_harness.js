...
function main() {
  ...
  assertCase(results, 'w422-version-marker-advanced',
    (drawer.includes('// @version      1.0.31') || drawer.includes('// @version      1.0.32')) &&
      (drawer.includes("const DRAWER_USERSCRIPT_VERSION = '1.0.31';") || drawer.includes("const DRAWER_USERSCRIPT_VERSION = '1.0.32';")) &&
      (drawer.includes("const CURRENT_UX_BLOCK_W346 = 'W422';") || drawer.includes("const CURRENT_UX_BLOCK_W346 = 'W423';")),
