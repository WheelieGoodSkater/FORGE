...
const EXPECTED_DRAWER_VERSION = '1.0.72';
const EXPECTED_VISIBLE_MARKER = 'Drawer 1.0.72 / W472';
  ...
  const checks = [
    ...
    },
    {
      ...
      pass: rootText.includes(`const DRAWER_USERSCRIPT_VERSION = '${EXPECTED_DRAWER_VERSION}';`) &&
        rootText.includes("const CURRENT_UX_BLOCK_W346 = 'W472';") &&
        ...
        mirrorText.includes("const CURRENT_UX_BLOCK_W346 = 'W472';") &&
